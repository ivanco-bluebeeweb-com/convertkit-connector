"""HTTP client for ConvertKit API."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.convertkit.com/v3"
...
class ConvertKitClient:
    def __init__(self, api_secret: str, base_url: str = ""):
        ...
        self.headers = {
            "Authorization": f"Bearer {self.api_secret}" if "Authorization" == "Authorization" else self.api_secret,
            "Content-Type": "application/json",
            "User-Agent": "Imperal-ConvertKit-Connector/1.0.0"
        }
