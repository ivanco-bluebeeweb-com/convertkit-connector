"""Settings panel for ConvertKit Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__convertkit_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=convertkit_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_convertkit"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("ConvertKit Settings & Accounts", level=2),
